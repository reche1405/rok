...
def create_app():
    ...
    with app.app_context():
        ...
        db.create_all()
        admin.add_view(ListAdminView(List, db, category="Static"))
        ...
        admin.add_view(UnitAdminView(Unit, db, category="Projects"))
        admin.add_view(MediaAdminView(Media, db, category="Static"))
        admin.add_view(BaseSecureView(Area, db, category="Areas"))
        admin.add_view(SlugifyAdminView(Location, db, category="Areas"))
        admin.add_view(BaseSecureView(Meta, db, category="Static"))
        admin.add_view(BaseSecureView(Page, db, category="Static"))
        admin.add_view(ArticleAdminView(Article, db, category="Blog"))
        admin.add_view(CachedAdminView(Social, db, category="Static"))
        admin.add_view(BaseSecureView(User, db, category="Auth"))
        admin.add_view(CachedAdminView(Policy, db, category="Static"))
