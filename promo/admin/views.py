...
class ProjectAdminView(BaseSecureView):
        ...
        if form.zip_file.data:
            ...
            if zip_file_storage.filename.endswith('.zip'):
                try:
                    ...
                    new_media_items = self.process_zip_upload(zip_file_storage)
    ...
    def process_zip_upload(self, zip_file_storage):
        """
        ...
        with ZipFile(zip_data, 'r') as archive:
            for file_info in archive.infolist():
                ...
                if raw_filename and self.allowed_file(raw_filename):
                    ...
                    slug = self.generate_unique_slug(name_without_ext)
    ...
    def generate_unique_slug(self, base_title):
